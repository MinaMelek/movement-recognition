...
def manip(human, directory='No'):
    col=['Humans', 'Nose_x','Nose_y','Nose_score','Neck_x','Neck_y','Neck_score','RShoulder_x','RShoulder_y','RShoulder_score',
         'RElbow_x','RElbow_y','RElbow_score','RWrist_x','RWrist_y','RWrist_score','LShoulder_x','LShoulder_y','LShoulder_score','LElbow_x','LElbow_y','LElbow_score',
         'LWrist_x','LWrist_y','LWrist_score','RHip_x','RHip_y','RHip_score','RKnee_x','RKnee_y','RKnee_score','RAnkle_x','RAnkle_y','RAnkle_score',
         'LHip_x','LHip_y','LHip_score','LKnee_x','LKnee_y','LKnee_score','LAnkle_x','LAnkle_y','LAnkle_score','REye_x','REye_y','REye_score',
         'LEye_x','LEye_y','LEye_score','REar_x','REar_y','REar_score','LEar_x','LEar_y','LEar_score']
    x_data=[]
    y_data=[]
    scores=[]
    all_data=[]
